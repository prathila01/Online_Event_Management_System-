        ...
        <div class="galleryContainer">
            <div class="slideShowContainer">
                ...
                <div class="imageHolder">
                    <img src="src/family/img_1.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_2.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_3.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_4.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_5.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_6.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_7.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_8.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_9.jpg">
                    <p class="captionText">Family</p>
                </div>
                <div class="imageHolder">
                    <img src="src/family/img_10.jpg">
                    <p class="captionText">Family</p>
                </div>
            </div>

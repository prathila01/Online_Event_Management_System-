    ...
    <div class="galleryContainer">
        <div class="slideShowContainer">
            ...
            <div class="imageHolder">
                <img src="src/other/img_1.jpg">
                <p class="captionText">Lindsey</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_2.jpg">
                <p class="captionText">Olivia</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_3.jpg">
                <p class="captionText"> Abby & Crew</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_4.jpg">
                <p class="captionText">jeans</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_5.jpg">
                <p class="captionText">Duel</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_6.jpg">
                <p class="captionText">Boxing</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_7.jpg">
                <p class="captionText">Gym</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_8.jpg">
                <p class="captionText">Road bicycle racing</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_9.jpg">
                <p class="captionText">100m</p>
            </div>
            <div class="imageHolder">
                <img src="src/other/img_10.jpg">
                <p class="captionText">BMX bike</p>
            </div>
